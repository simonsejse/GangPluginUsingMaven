...
public class InventoryUtility
{
    ...
    public static final ItemStack BACK_ITEM = new ItemBuilder(Material.BED).setItemName("&c&lTilbage").setLore("&fKlik her for at", "&fgå tilbage til forrige menu").buildItem();
    ...
    public static void decorate(Inventory inv, IntPredicate intPredicate, ItemStack item, boolean setBed){
        ...
        if (setBed) inv.setItem(49, BACK_ITEM);
    }
    ...
    //InfoMenu
    public static final int ECONOMY_SLOT = 10, MEMBERS_SLOT = 12, GANG_INFORMATION_SLOT = 14, LIMITS_SLOT = 16, CHANGELOG_SLOT = 20, EMBLEM_SLOT = 24, LEVEL_SLOT = 28, ALLY_SLOT = 30, ENEMY_SLOT = 32, GANG_SHOP_SLOT = 34, PERMISSION_SLOT = 47, DELETE_SLOT = 51;
    //MainMenu
